    ...
    <div className="pt-20 min-h-screen bg-white">
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none
          ...
          prose-h2:text-[32px] prose-h2:mt-16 prose-h2:mb-8 prose-h2:leading-tight
          prose-h3:text-[24px] prose-h3:mt-12 prose-h3:mb-6 prose-h3:leading-snug
          prose-h4:text-[20px] prose-h4:mt-8 prose-h4:mb-4 prose-h4:text-[var(--primary-teal)]
          prose-p:text-[18px] prose-p:text-gray-800 prose-p:leading-[1.8] prose-p:mb-8
          prose-a:text-[var(--primary-teal)] prose-a:font-semibold prose-a:underline prose-a:decoration-2 prose-a:underline-offset-2 hover:prose-a:text-[var(--accent-orange)]
          prose-strong:font-bold prose-strong:text-[#1C355E]
          prose-ul:my-8 prose-ul:space-y-3 prose-ul:pl-0
          prose-ol:my-8 prose-ol:space-y-3 prose-ol:pl-0
          prose-li:text-[18px] prose-li:text-gray-800 prose-li:leading-[1.8] prose-li:ml-6 prose-li:pl-2
          prose-li:marker:text-[var(--accent-orange)]
          prose-blockquote:border-l-4 prose-blockquote:border-[var(--accent-orange)] prose-blockquote:pl-8 prose-blockquote:pr-4 prose-blockquote:py-4 prose-blockquote:italic prose-blockquote:text-[20px] prose-blockquote:text-gray-700 prose-blockquote:my-12 prose-blockquote:bg-gray-50 prose-blockquote:rounded-r-lg
          prose-code:text-[var(--primary-teal)] prose-code:bg-gray-100 prose-code:px-2 prose-code:py-1 prose-code:rounded prose-code:text-[16px] prose-code:font-mono
          prose-pre:bg-gray-900 prose-pre:text-gray-100 prose-pre:p-6 prose-pre:rounded-lg prose-pre:my-10
        ">
